...
public class ItemRegistryHandler {
    ...
    public static final ItemConcreteDust CONCRETE_DUST = new ItemConcreteDust();

    // 新增物品
    public static final ItemCementBag CEMENT_BAG = new ItemCementBag(); // 水泥袋
    ...
    // 新增方块物品
    public static final ItemBlock ITEM_CEMENT_MIXER = withRegistryName(
            new ItemBlockMachine(
                    BlockRegistryHandler.BLOCK_CEMENT_MIXER,
                    "tooltip.cementmod.cement_mixer"
            )
    );
    public static final ItemBlock ITEM_CEMENT_PACKER = withRegistryName(
            new ItemBlockMachine(
                    BlockRegistryHandler.BLOCK_CEMENT_PACKER,
                    "tooltip.cementmod.cement_packer"
            )
    );
    public static final ItemBlock ITEM_ITEM_EXTRACTOR = withRegistryName(
            new ItemBlockMachine(
                    BlockRegistryHandler.BLOCK_ITEM_EXTRACTOR,
                    "tooltip.cementmod.item_extractor"
            )
    );
    ...
    public static void onRegistry(RegistryEvent.Register<Item> event) {
        ...
        registry.register(CONCRETE_DUST);

        // 注册新增物品
        registry.register(CEMENT_BAG); // 水泥袋
        ...
        // 注册新增方块物品
        registry.register(ITEM_CEMENT_MIXER);
        registry.register(ITEM_CEMENT_PACKER);
        registry.register(ITEM_ITEM_EXTRACTOR);

        // 添加矿石词典
        OreDictionary.registerOre("toolHammer", HAMMER);
        OreDictionary.registerOre("dustLime", LIME_POWDER);
        OreDictionary.registerOre("dustCement", CEMENT_POWDER);
        OreDictionary.registerOre("bagCement", CEMENT_BAG); // 水泥袋矿石词典
    }
    ...
    public static void onModelRegistry(ModelRegistryEvent event) {
        ...
        registerModel(CONCRETE_DUST);

        // 注册新增物品模型
        registerModel(CEMENT_BAG); // 水泥袋
        ...
        // 注册新增方块物品模型
        registerModel(ITEM_CEMENT_MIXER);
        registerModel(ITEM_CEMENT_PACKER);
        registerModel(ITEM_ITEM_EXTRACTOR);
    }
}
